...
public abstract class AbstractStringArraySorterTest {
    public static final boolean ASCENDING = true;
    public static final boolean DESCENDING = false;

    protected abstract Sorter<String[]> getStringComparableArraySorter();

    @Test
    @Parameters(method = "arraysToSortAndResults")
    public void shouldSort(String[] expectedArray, String[] arrayToSort) throws Exception {
        // Given
        Sorter<String[]> sorter = getStringComparableArraySorter();
